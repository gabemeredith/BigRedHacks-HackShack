        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          {sidebarOpen && (
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xs bg-primary-100 text-primary-600 px-2 py-1 rounded-full">Dashboard</span>
            </Link>
          )}
          <button
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 truncate">
                  {userInfo.user.business?.name || 'No business linked'}
                </p>
              </div>
            </div>
          </div>
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              {userInfo?.user?.business && (
                <p className="text-sm text-gray-600 mt-1">
                  Managing: {userInfo.user.business.name}
                </p>
              )}
            </div>
            ...
            <div className="flex items-center space-x-4">
              <Link
                to={userInfo?.user?.business ? `/business/${userInfo.user.business._id}` : '/'}
