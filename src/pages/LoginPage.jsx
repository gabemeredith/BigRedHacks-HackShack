...
const LoginPage = () => {
  ...
  const { login, loading, error, clearError, userInfo } = useAuth();
  ...
  // Note: Removed automatic redirect - let users visit login page even if logged in
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <UnifiedHeader currentPage="login" />
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-12 text-white">
          <div className="max-w-md">
            <h1 className="text-4xl font-bold mb-6">Welcome to LocalLens</h1>
            <p className="text-xl mb-8 text-purple-100">
              Manage your business profile, upload videos, and connect with local customers.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span>Showcase your business with videos</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-purple-400 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            {userInfo && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex">
                  ...
                  <div>
                    <p className="text-blue-800 text-sm font-medium">You're already logged in as {userInfo.user?.businessName || userInfo.user?.name}</p>
                    <p className="text-blue-700 text-sm mt-1">
                      <button onClick={() => navigate('/dashboard')} className="underline hover:no-underline">
                        Go to Dashboard
                      </button> or <button onClick={() => navigate('/')} className="underline hover:no-underline">
                        Return Home
                      </button>
                    </p>
                  </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 pr-10"
